...
class DzikirPetangScreen extends StatelessWidget {
  const DzikirPetangScreen({super.key});
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const SizedBox(height: 25),
              Text(
                '8. Membaca Sayyidul Istighfar (Penghulu Istighfar)',
                style: TextStyle(fontFamily: 'PoppinsSemiBold', fontSize: 18),
              ),
              const SizedBox(height: 8),
              const Text(
              ...
              const Text(
                "Allhumma 'aafnii fi badanii, Allhumma'aafinii fi sam'i, Allahumma 'aafinii fi bashori, Laa ilaaha illa anta. Allhumma innii a'uudzubika minal kufri wal faqr, wa a'uudzubika min 'adzaabil qobri, laa ilaaha ila anta",
                style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500),
                textAlign: TextAlign.center,
              ),
              const Text(
              ...
              const SizedBox(height: 25),
              Text(
                "19. Membaca doa perlindungan malam hari",
                style: TextStyle(fontFamily: 'PoppinsSemiBold', fontSize: 18),
                textAlign: TextAlign.center,
              ),
              Container(
              ...
              const Text(
                "A'uudzu bikalimaatillahit-taammati min syarri maa kholaq",
                style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500),
                textAlign: TextAlign.center,
              ),
              const Text(
